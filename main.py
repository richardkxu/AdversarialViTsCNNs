...
from engine import train_one_epoch, evaluate_nograd
...
def main(args):
    ...
    if args.eval:
        ...
        test_stats = evaluate_nograd(data_loader_val, model, device, args.amp_dtype, args.use_amp)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if data_loader_val is not None and epoch_to_save:
            ...
            if args.model_ema and args.model_ema_eval:
                test_stats_ema = evaluate_nograd(data_loader_val, model_ema.ema, device, args.amp_dtype, args.use_amp)
